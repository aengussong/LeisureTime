...
public class TreeViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private StableItemIdProvider itemIdProvider;
    ...
    public long getItemId(int position) {
        if (itemIdProvider == null)
            ...
            return itemIdProvider.getItemId(displayNodes.get(position));
    }
    ...
    public void setStableItemIdProvider(StableItemIdProvider itemIdProvider) {
    ...
    public interface StableItemIdProvider {

        long getItemId(TreeNode node);
